...
- **Receive shares from other apps**: Freizone appears in the system share sheet for text and images, and your recent chats show up as individual targets in its direct-share row — a shared link lands in that chat's composer, a shared picture lands staged next to it, and neither is sent until you press send. Because making a chat a share target means handing its name and avatar to Android's shortcut store, that part is a Settings switch you can turn off, which removes what was published.
